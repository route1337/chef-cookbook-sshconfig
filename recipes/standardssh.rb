...
case node['platform']
  when 'ubuntu', 'centos'
    ...
    # Set the server bits to 1024
    node.default['openssh']['server']['server_key_bits'] = '1024'
    ...
    node.default['openssh']['server']['login_grace_time'] = '120'
    ...
    node.default['openssh']['server']['x11_display_offset'] = '10'
